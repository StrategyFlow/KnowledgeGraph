...
- `src/london_project/input/` — included sample input directory.
- `src/london_project/output/` — included sample output directory.
- `input/` — default runtime input directory (controlled by `INPUT_DIR`).
- `output/` — default runtime output directory generated by the pipeline.
...
1. Add `.txt`, `.md`, `.json`, or `.pdf` files to your input folder (default: `input/` at repo root).
2. Run:
...
3. Check generated outputs in `output/` at repo root.
